 ...
 * 
 * A premium mobile-first storm game where you intercept lightning
 * before it connects with upward streamers on the ground.
 */
...
const LIGHTEND = () => {
  ...
  const triggerHaptic = (pattern = 'medium') => {
    ...
    try {
      ...
      // Silently fail if vibration unavailable
    }
  };
